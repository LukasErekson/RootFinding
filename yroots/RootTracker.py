...
class RootTracker:
    '''
    Class to track the roots that are found found using the subdivision
    solver.
    ...
    possible_duplicates : list
        Roots that were outside their search interval, so they might be
        duplicates.
    ...
    add_roots
        Adds roots the were found to the list, along with their
        information.
    add_potential_roots
        Adds roots that were found by the solver but are questionable.
        We will want to double check that these roots aren't duplicated
        elsewhere or that they give a fairly good answer.
    ...
    def add_roots(self, zeros, a, b, method):
        ''' Store the roots that were found, along with the interval
    ...
    def add_root(self, zero, a, b, method):
        ''' Store the root that was found, along with the interval it
        was found in and the method used.
    ...
    def add_potential_roots(self, potentials, a, b, method):
        ''' Store the potential roots that were found, along with the
        interval they were found in and the method used.
    ...
    def get_polish_intervals(self):
        ...
        Deletes the rest of the info as subdivision will be rerun on
        these intervals.
