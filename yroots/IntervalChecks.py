...
class IntervalData:
    ...
    def __init__(self,a,b):
        ...
        self.approx_err_dict = {i:[] for i in range(100)}
        self.trim_err_dict = {i:[] for i in range(100)}
        self.target_tol_dict = {i:[] for i in range(100)}
        self.good_degs_dict = {i:[] for i in range(100)}
